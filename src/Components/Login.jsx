...
export function LoginFormDemo() {
  ...
  return (
    <div
      className="shadow-input mx-auto w-screen-[80%] max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border-1 border-gray-600 mt-5">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button
            className="group/btn shadow-input relative flex h-10 w-full items-center justify-start space-x-2 rounded-md bg-gray-50 px-4 font-medium text-black dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_#262626]"
            type="submit">
            <IconBrandLinkedinFilled className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />
            <span className="text-sm  text-neutral-700 dark:text-neutral-300">
              Linked in
            </span>
            {/* <BottomGradient /> */}
