...
export function HeroSectionOne() {
  return (
    <div
      className="relative mx-auto my-10 flex flex-col items-center justify-center max-w-[80%]">
      <Navbar />
      <div
        ...
        <motion.div
          ...
          <div
            ...
            {/* <Image
              ...
              height={1000}
              width={1000} /> */}
              <img src='https://assets.aceternity.com/pro/aceternity-landing.webp'
              alt="Landing page preview"
              className="aspect-[16/9] h-auto w-full object-cover"
              height={1000}
              width={1000} />
  ...
  return (
    <nav
      ...
      <div className="flex items-center gap-2">
        <div>
        <h1 className="text-base font-bold md:text-2xl text-white">mentor Connect</h1>
